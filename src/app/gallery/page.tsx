...
const images = Array.from({ length: 77 }, (_, i) => ({
    src: `/${i + 1}.jpeg`,
    alt: `Beauty Plug Product ${i + 1}`,
}));
        ...
        <div className="min-h-screen" style={{ background: '#FAF8F4', fontFamily: "'Georgia', serif" }}>
            ...
            <div className="pt-32 pb-16 text-center px-6">
                ...
                <p className="font-sans text-base max-w-sm mx-auto leading-relaxed" style={{ color: '#7A7065' }}>
                    See something you like? Tap any image to order via WhatsApp. Can't find what you're looking for? Send us a message, we may have it in stock or can help you find it.
                </p>
            </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {images.map((img, i) => (
                        <a
                            ...
                            style={{ borderRadius: '4px', aspectRatio: '1/1', background: '#E8E3D9' }}
                        >
                            <Image
                                src={img.src}
                                alt={img.alt}
            ...
            <div className="py-20 text-center px-6" style={{ background: '#1C1C1A' }}>
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block px-12 py-4 font-sans font-semibold text-sm uppercase tracking-widest transition-all duration-300"
            ...
            <footer style={{ background: '#111110', color: 'white' }} className="py-12">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <p className="font-sans text-xs" style={{ color: 'rgba(255,255,255,0.2)' }}>
                        &copy; 2026 Beauty Plug Co. All rights reserved.
                    </p>
                </div>
            </footer>
        </div>
